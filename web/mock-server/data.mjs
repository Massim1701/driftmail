...
// message: { id, fromAddress, fromDisplayName, subject, receivedAt, folder, classification, bodyText, security }
...
export function summaryFor(msg) {
  const actionRequired = msg.security.classification === "phishing" || msg.security.classification === "spam"
    ? false
    : msg.folder === "rechnungen";
  return {
    ...
    actionDescription: actionRequired
      ...
      : null,
    deadline: msg.folder === "rechnungen" ? "2026-09-15" : null,
