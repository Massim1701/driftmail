...
[2026-09-21] [teilweise erledigt: Backend-Grundlage fuer 1/2/4 (571ee2c); Punkt 3 + 5 brauchten keine Aenderung (5 bereits vollstaendig fertig, siehe backend/README.md); iOS-UI fuer 1/2/3/4 fertig (cbfbeec, siehe ios/README.md); Web-UI fuer 1/2/3/4 noch offen] [FUENF NEUE KOMFORT-FEATURES] [contracts + Track A + Track C/F] — Massimo hat fuenf weitere Vorschlaege bestaetigt, alle sollen umgesetzt werden. Vorab geklaert: dauerhafte Anmeldung ist bereits geloest (iOS Keychain, Web localStorage), kein Bug.
