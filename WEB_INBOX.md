...
[2026-09-21] [offen] [NEUE GRUNDLAGE - HTML-Rendering des Mail-Bodies] [contracts + Track A + Track C/F] [hohe Prioritaet - macht zwei bereits gebaute Features erst funktionsfaehig] — Massimo: Code hat ehrlich gemeldet, dass Tracking-Pixel-Blockierung und Klick-Zeit-Link-Pruefung beide praktisch wirkungslos sind, weil Mail-Bodies aktuell nicht als HTML gerendert werden (nur Rohtext, vermutlich). Bitte HTML-Rendering als eigene, saubere Grundlage nachziehen.
