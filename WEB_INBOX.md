...
[2026-09-21] [teilweise erledigt: Backend 1a82351 (Punkt 2 Nudge + Punkt 3 Vertraulicher Modus; Punkt 1 braucht keine Backend-Aenderung); Track C (iOS) UI fuer alle drei Punkte fertig (a8ff66f, siehe ios/README.md -- Punkt 3s automatischer Vorschlag bewusst NICHT gebaut, siehe dort); Track F (Web) UI noch offen] [DREI WEITERE FEATURES - Gmail-Recherche] [contracts + Track A + Track C/F] — Massimo hat nach Recherche zu Gmail-spezifischen Funktionen drei Uebernahmen bestaetigt.
